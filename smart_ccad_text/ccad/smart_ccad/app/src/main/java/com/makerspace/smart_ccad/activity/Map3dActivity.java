...
public class Map3dActivity extends BaseActivity implements AMapLocationListener, AMap.OnMyLocationChangeListener, INaviInfoCallback {
...
//    public AMapLocationClientOption mLocationOption = null;
    ...
    protected void initCustomView(Bundle savedInstanceState) {
        setContentView(R.layout.gao_de_map_three);
...
//            markerOption.title(title.get(i)).snippet(desc.get(i));
        ...
        aMap.setOnInfoWindowClickListener(new AMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                AmapNaviPage.getInstance().showRouteActivity(Map3dActivity.this, new AmapNaviParams(start, null, end, AmapNaviType.DRIVER), Map3dActivity.this);
